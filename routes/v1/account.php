...
Route::post('/account/register/{list?}', [RegisterController::class, 'register']);
Route::get('/account/verify/{list?}', [RegisterController::class, 'showVerify'])->name('account.verify');
Route::post('/account/verify/{list?}', [RegisterController::class, 'verify']);
Route::post('/account/verify/{list?}/resend', [RegisterController::class, 'resendOtp'])->name('account.verify.resend');
...
Route::post('/account/forgot-password', [AccountController::class, 'sendResetOtp']);
