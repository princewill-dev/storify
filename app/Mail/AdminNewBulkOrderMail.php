...
class AdminNewBulkOrderMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'New Bulk Order Received - ' . $this->bulkOrder->bulk_code,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.bulk.admin-new-order',
            with: [
                ...
                'adminUrl' => config('app.url') . '/superadmin',
            ],
        );
    }
}
