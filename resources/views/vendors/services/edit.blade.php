...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('vendor.services.index', ['vendor' => $vendor]) }}" class="btn btn-light">Back</a>
  </div>

  <div class="card">
    <div class="card-body">
      <form method="post" action="{{ route('vendor.services.update', ['vendor' => $vendor, 'service' => $service]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row g-3">
          <div class="col-md-6">
