    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            @if(request()->hasAny(['search', 'status', 'country']))
                ...
                <a href="{{ route('vendor.customers.index', ['vendor' => $vendor]) }}" class="btn btn-sm btn-outline-secondary">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-light text-dark border">{{ ucfirst(strtolower($customer->status)) }}</span>
                            </td>
                            <td>{{ $customer->created_at->format('M d, Y') }}</td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <a href="{{ route('vendor.customers.show', ['vendor' => $vendor, 'customer' => $customer]) }}" class="btn btn-outline-secondary btn-sm" title="View">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a href="{{ route('vendor.customers.edit', ['vendor' => $vendor, 'customer' => $customer]) }}" class="btn btn-outline-secondary btn-sm" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @if($customer->status === \App\Models\Customer::STATUS_ACTIVE)
                                    <button type="button" class="btn btn-outline-danger btn-sm" title="Suspend"
                                    ...
                                    <button type="button" class="btn btn-outline-success btn-sm" title="Activate"
...
<div class="modal fade" id="filterModal" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('vendor.customers.index', ['vendor' => $vendor]) }}">
                ...
                <div class="modal-footer">
                    <a href="{{ route('vendor.customers.index', ['vendor' => $vendor]) }}" class="btn btn-secondary">
