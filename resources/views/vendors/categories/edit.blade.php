...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-body">
      <form method="post" action="{{ route('vendor.categories.update', ['vendor' => $vendor, 'category' => $category]) }}">
        @csrf
        @method('PUT')
        <div class="row g-3">
          <div class="col-md-4">
        ...
        <div class="mt-4 d-flex gap-2">
          ...
          <a class="btn btn-light" href="{{ route('vendor.categories.index', ['vendor' => $vendor, 'store_id' => request('store_id')]) }}">Cancel</a>
        </div>
      </form>
    </div>
  </div>
