...
<div class="card shadow-sm">
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <form action="{{ route('vendor.payment-methods.skip', ['vendor' => $vendor]) }}" method="POST" class="d-inline">
                @csrf
            ...
            @if($configuredMethod)
                <a href="{{ route('vendor.delivery-routes.form', ['vendor' => $vendor]) }}" class="btn btn-primary">
...
<div class="modal fade" id="bankModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('vendor.payment-methods.bank', ['vendor' => $vendor]) }}" method="POST" id="bankForm">
                @csrf
...
<div class="modal fade" id="paystackModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('vendor.payment-methods.paystack', ['vendor' => $vendor]) }}" method="POST" id="paystackForm">
                @csrf
                <div class="modal-body">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadBanksIntoSelector(selector) {
            ...
            if (banksCache) {
                ...
                fetch("{{ route('vendor.store.get-banks', ['vendor' => $vendor]) }}")
