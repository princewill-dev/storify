			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="text-end">
						...
						<div class="about-2-img a-2-1 r-12">
							<img class="img-fluid" src="{{ asset('home/images/a2-1.jpg') }}" alt="about-image">
						</div>


						<!-- IMAGE-2 -->
						<div class="about-2-img a-2-2 r-12">
							<img class="img-fluid" src="{{ asset('home/images/a2-2.jpg') }}" alt="about-image">
						</div>
				...
				<div class="col-md-7">
					...
					<div class="about-2-img a-2-3 r-12">
						<img class="img-fluid" src="{{ asset('home/images/a2-3.jpg') }}" alt="about-image">
					</div>
					...
					<div class="row">
						...
						<div class="col-md-5 col-lg-6">
							<div class="about-2-img a-2-4 r-12">
								<img class="img-fluid" src="{{ asset('home/images/a2-4.jpg') }}" alt="about-image">
							</div>
						</div>
				...
				<div class="col text-center">	
					<div class="owl-carousel brands-carousel-6">
						...
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-1.png') }}" alt="brand-logo"></a>
						</div>

											
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-2.png') }}" alt="brand-logo"></a>
						</div>

											
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-3.png') }}" alt="brand-logo"></a>
						</div>

											
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-4.png') }}" alt="brand-logo"></a>
						</div>

											
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-5.png') }}" alt="brand-logo"></a>
						</div>

											
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-6.png') }}" alt="brand-logo"></a>
						</div>


						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-7.png') }}" alt="brand-logo"></a>
						</div>

													
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-8.png') }}" alt="brand-logo"></a>
						</div>

						
						<!-- BRAND LOGO IMAGE -->
						<div class="brand-logo">
							<a href="#"><img class="img-fluid" src="{{ asset('home/images/brand-9.png') }}" alt="brand-logo"></a>
						</div>
				...
				<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
						...
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-1.jpg') }}" alt="team-member-foto">
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-2.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-3.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-4.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-5.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-6.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-7.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="col">
						<div class="team-member mb-50 wow fadeInUp">
							...
							<div class="team-member-photo r-14">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="{{ asset('home/images/team-13.jpg') }}" alt="team-member-foto">
									<div class="item-overlay"></div>
								</div>
							</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="{{ asset('home/images/img-08.png') }}" alt="content-image">
							</div>
						</div>
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-6">
					<div class="img-block left-column wow fadeInRight">
						<img class="img-fluid" src="{{ asset('home/images/img-07.png') }}" alt="content-image">
					</div>
				</div>
							...
							<div class="review-txt">
								...
								<div class="author-data clearfix">
									...
									<div class="review-avatar">
										<img src="{{ asset('home/images/review-author-1.jpg') }}" alt="review-avatar">
									</div>
						...
						<div id="rw-2-2" class="review-2 bg--white-100 block-shadow r-08">
							...
							<div class="review-txt">
								...
								<div class="author-data clearfix">
									...
									<!-- Avatar -->
									<div class="review-avatar">
										<img src="{{ asset('home/images/review-author-2.jpg') }}" alt="review-avatar">
									</div>
						...
						<div id="rw-2-3" class="review-2 bg--white-100 block-shadow r-08">
							...
							<div class="review-txt">
								...
								<div class="author-data clearfix">
									...
									<!-- Avatar -->
									<div class="review-avatar">
										<img src="{{ asset('home/images/review-author-5.jpg') }}" alt="review-avatar">
									</div>
						...
						<div id="rw-2-4" class="review-2 bg--white-100 block-shadow r-08">
							...
							<div class="review-txt">
								...
								<div class="author-data clearfix">
									...
									<!-- Avatar -->
									<div class="review-avatar">
										<img src="{{ asset('home/images/review-author-8.jpg') }}" alt="review-avatar">
									</div>
				...
				<div class="row justify-content-md-center row-cols-1 row-cols-md-3">
					...
					<div class="col">
						<div id="rb-1-1" class="rbox-1">
							...
							<div class="rbox-1-img">
								<img class="img-fluid" src="{{ asset('home/images/brand-21.png') }}" alt="feature-image">
							</div>
					...
					<div class="col">
						<div id="rb-1-2" class="rbox-1">
							...
							<!-- Brand Logo -->
							<div class="rbox-1-img">
								<img class="img-fluid" src="{{ asset('home/images/brand-22.png') }}" alt="feature-image">
							</div>
					...
					<div class="col">
						<div id="rb-1-3" class="rbox-1">
							...
							<!-- Brand Logo -->
							<div class="rbox-1-img">
								<img class="img-fluid" src="{{ asset('home/images/brand-23.png') }}" alt="feature-image">
							</div>
		...
		<div class="container">
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-6 col-lg-7 order-first order-md-2">
					<div class="img-block right-column wow fadeInLeft">
						<img class="img-fluid" src="{{ asset('home/images/img-14.png') }}" alt="content-image">
					</div>
				</div>
