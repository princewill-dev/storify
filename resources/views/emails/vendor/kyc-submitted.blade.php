        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:12px;box-shadow:0 1px 2px rgba(16,24,40,.06);">
          ...
          <tr>
            <td style="padding:0 32px 28px;">
              <a href="{{ route('vendor.stores.create', ['vendor' => $vendor]) }}" style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;border-radius:8px;padding:10px 16px;font-weight:600;font-size:14px;">Continue store setup</a>
            </td>
          </tr>
          <tr>
