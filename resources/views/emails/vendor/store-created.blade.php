        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:12px;box-shadow:0 1px 2px rgba(16,24,40,.06);">
          ...
          <tr>
            <td style="padding:8px 32px 4px;">
              <h1 style="margin:0;font-size:22px;line-height:28px;color:#111827;font-weight:700;">Your store is live 🎉</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:0 32px 16px;">
              <p style="margin:0;color:#334155;font-size:14px;line-height:20px;">Hi, your store has been created on {{ $company->name ?? 'our platform' }}.</p>
            </td>
          </tr>
          <tr>
              ...
              <div style="background:#f1f5f9;border-radius:10px;padding:16px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;color:#0f172a;">
                  ...
                  <tr>
                    ...
                    <td style="padding:6px 0;"><span style="background:#ecfeff;color:#0e7490;padding:2px 8px;border-radius:999px;">{{ $store->status }}</span></td>
                  </tr>
                </table>
              </div>
            </td>
          ...
          <tr>
            <td style="padding:0 32px 28px;">
              <a href="#" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;border-radius:8px;padding:10px 16px;font-weight:600;font-size:14px;">Manage store</a>
            </td>
          </tr>
          <tr>
