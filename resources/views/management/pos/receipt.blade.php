...
<div class="flex items-center gap-3 mb-6">
    <a href="{{ config('pos.link') }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-slate-500 hover:text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors">
...
<div class="max-w-lg mx-auto">
    ...
    <a href="{{ config('pos.link') }}" target="_blank" rel="noopener" class="block w-full mt-4 py-2.5 bg-slate-900 text-white text-sm font-semibold rounded-lg hover:bg-slate-800 transition-colors text-center">New Sale</a>
</div>
@endsection
