    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <table class="min-w-full divide-y divide-slate-200">
            <thead class="bg-slate-50">
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase">Order</th>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-12 text-center text-sm text-slate-400">No orders found for this store.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
