...
@section('subtitle', 'AR Aging')

@section('content')

<x-management.page-header title="Accounts Receivable Aging" subtitle="Outstanding customer invoices as of {{ \Illuminate\Support\Carbon::parse($asOf)->format('d M Y') }}">
    <x-slot:actions>
    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-slate-50">
            ...
            <tr><td colspan="7" class="px-5 py-12">
                <x-management.empty-state icon="fi fi-rr-time-past" title="Nothing outstanding" description="All customer invoices are settled." />
            </td></tr>
            @endforelse
        </tbody>
