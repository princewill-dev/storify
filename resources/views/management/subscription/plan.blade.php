...
<div class="mb-8" x-data="{ billingCycle: '{{ $subscription?->subscriptionPlan?->interval === 'yearly' ? 'yearly' : 'monthly' }}' }">
    ...
    {{-- Monthly plans --}}
    <div x-show="billingCycle === 'monthly'" class="{{ $monthlyPlans->count() === 1 ? 'max-w-md mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-5' }}">
    ...
    {{-- Yearly plans --}}
    <div x-show="billingCycle === 'yearly'" x-cloak class="{{ $yearlyPlans->count() === 1 ? 'max-w-md mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-5' }}">
    ...
    <div class="mt-8">
        ...
        <div class="{{ $otherPlans->count() === 1 ? 'max-w-md mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-5' }}">
