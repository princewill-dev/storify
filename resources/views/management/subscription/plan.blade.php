...
<div class="max-w-5xl mx-auto mb-8" x-data="{ billingCycle: '{{ $subscription?->subscriptionPlan?->interval === 'yearly' ? 'yearly' : 'monthly' }}' }">
    ...
    {{-- Monthly plans --}}
    <div x-show="billingCycle === 'monthly'" class="{{ $monthlyPlans->count() === 1 ? 'max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-4' }}">
    ...
    {{-- Yearly plans --}}
    <div x-show="billingCycle === 'yearly'" x-cloak class="{{ $yearlyPlans->count() === 1 ? 'max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-4' }}">
    ...
    <div class="mt-8">
        ...
        <div class="{{ $otherPlans->count() === 1 ? 'max-w-sm mx-auto' : 'grid grid-cols-1 md:grid-cols-3 gap-4' }}">
