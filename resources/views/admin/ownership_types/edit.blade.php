...
@section('subtitle', 'Edit Ownership Type')

@section('content')
<div class="flex items-center justify-between mb-6">
    <h2 class="text-lg font-bold text-slate-900">Edit ownership type</h2>
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="p-6">
        <form method="post" action="{{ route('admin.ownership-types.update', $type) }}">
            @csrf
            @method('PUT')
