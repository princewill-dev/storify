...
<div class="flex flex-wrap items-center justify-between gap-4 mb-4">
    <form method="GET" class="flex items-center gap-2">
        ...
        @if($status)
            <a href="{{ route('admin.business-kyc.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50">Reset</a>
        @endif
    </form>
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-4 py-3">
                            @if($application->business)
                                <a href="{{ route('admin.businesses.show', $application->user) }}" class="font-medium text-slate-900 hover:text-indigo-600">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('admin.business-kyc.show', $application) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-slate-900 text-white hover:bg-slate-800">
                                Review
                            </a>
                        </td>
                    </tr>
