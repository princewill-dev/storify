...
@section('subtitle', 'Review business verification details')
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-100">
                <h3 class="text-sm font-semibold text-slate-900">Business Snapshot</h3>
            </div>
            <div class="px-5 py-4 space-y-2">
                ...
                <a href="{{ route('admin.businesses.show', $application->user) }}" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 w-full justify-center mt-2">
        ...
        @if($isActionable)
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="px-5 py-4 space-y-4">
                    <form method="POST" action="{{ route('admin.business-kyc.approve', $application) }}" class="space-y-3">
                        @csrf
                        <div>
                    ...
                    <form method="POST" action="{{ route('admin.business-kyc.reject', $application) }}" class="space-y-3">
                        @csrf
                        <div>
