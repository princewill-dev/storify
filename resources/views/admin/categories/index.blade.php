...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex">
      @if(!empty($store))
        <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#createCategoryModal">New category</button>
        ...
        <tbody>
          @forelse($categories as $c)
            <tr>
              ...
              <td class="text-end">
                <a href="{{ route('admin.categories.edit', $c) }}" class="btn btn-sm p-1 border-0 bg-transparent text-primary" title="Edit">
                  <i class="fa fa-pen"></i>
                </a>
                <button type="button" class="btn btn-sm p-1 border-0 bg-transparent text-danger" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal" data-action="{{ route('admin.categories.destroy', $c) }}" data-name="{{ $c->name }}" title="Delete">
