...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      ...
      <a href="{{ $backUrl ?? route('admin.products.index') }}" class="btn btn-light btn-sm">Back</a>
    </div>
  </div>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-md-4">
              <div class="mb-1 text-muted">Bulk Pricing</div>
              <div class="fw-semibold">
                {{ $sym }}{{ number_format((float)$product->bulk_price, 2) }}
                <span class="text-muted small">(Total for {{ $product->bulk_quantity }} units)</span>
              </div>
            </div>
            @endif
            <div class="col-md-4">
