...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      @if(!empty($store))
        <a href="{{ route('admin.stores.product.create', $store) }}" class="btn btn-primary me-2">New product</a>
        <a href="{{ route('admin.stores.show', $store) }}" class="btn btn-light">Back</a>
      @else
        <a href="{{ route('admin.products.create') }}" class="btn btn-primary me-2">New product</a>
        ...
        <tbody>
          @forelse($products as $p)
            <tr>
              ...
              <td class="text-end">
                <a class="btn btn-sm p-1 border-0 bg-transparent text-secondary" href="{{ isset($store) ? route('admin.stores.products.show', ['store' => $store, 'code' => $p->product_code]) : route('admin.products.show', $p) }}" title="View">
                  <i class="fa fa-eye"></i>
                </a>
                <a class="btn btn-sm p-1 border-0 bg-transparent text-primary" href="{{ route('admin.products.edit', $p) }}" title="Edit">
                  <i class="fa fa-pen"></i>
                </a>
                @if($p->status === 'active')
