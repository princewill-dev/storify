...
<div class="container-fluid">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    @if($pre && ($storeForBack = ($stores->firstWhere('id', $pre) ?? null)))
      <a href="{{ route('admin.stores.products.index', $storeForBack) }}" class="btn btn-light">Back</a>
    @else
              ...
              <div class="card-body">
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input type="number" name="bulk_quantity" class="form-control" value="{{ old('bulk_quantity') }}" placeholder="e.g. 50">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" name="bulk_price" class="form-control" value="{{ old('bulk_price') }}" placeholder="e.g. 2000.00">
