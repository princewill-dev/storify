...
@section('subtitle', 'Bulk Buy Orders')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h1 class="h3 mb-0">Bulk Buy Orders</h1>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            @if(request()->hasAny(['search', 'status', 'payment_status', 'store_id', 'date_from', 'date_to']))
                ...
                <a href="{{ route('admin.bulkbuy.orders.index') }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="text-center py-4 text-muted">No bulk buy orders found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="filterModalLabel">Filter Bulk Buy Orders</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="GET" action="{{ route('admin.bulkbuy.orders.index') }}">
                ...
                <div class="modal-footer">
                    <a href="{{ route('admin.bulkbuy.orders.index') }}" class="btn btn-secondary">
