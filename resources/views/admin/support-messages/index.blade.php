        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Support Messages Management</h4>
                    <div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @if($message->reply)
                                                <div class="mb-3">
                                                    <p class="mb-1"><strong>Reply ({{ ucfirst($message->replied_by_type) }}):</strong></p>
                                        ...
                                        <div class="modal-content">
                                            <form action="{{ route('admin.support-messages.destroy', $message) }}" method="POST">
                                                ...
                                                <div class="modal-header bg-danger text-white">
                                                    <h5 class="modal-title">Delete Support Message</h5>
                                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Are you sure you want to delete this support message?</p>
                                                    <div class="alert alert-warning">
                                                        <strong>From:</strong> {{ $message->name }}<br>
                                                        <strong>Store:</strong> {{ $message->store->name }}<br>
                                                        <strong>Message:</strong> {{ Str::limit($message->message, 100) }}
                                                    </div>
