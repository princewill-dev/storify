    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.transactions.index') }}" class="btn btn-outline-secondary">Reload</a>
            </div>
        </div>
    </div>
    ...
    <form method="GET" action="{{ route('admin.transactions.index') }}" class="mb-4">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('admin.transactions.index') }}" class="btn btn-outline-secondary w-100">Reset</a>
            </div>
        </div>
    </form>
